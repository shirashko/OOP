 ...
 * The conversation initiates with a predefined seed statement and subsequently continues based on each
 * bot's response.
 *
...
public class Chat {
    ...
    private static ChatterBot[] initializeChatterBots() {
        ...
        return new ChatterBot[]{
                new ChatterBot(FIRST_CHATTER_BOT_NAME, firstChatterBotLegalResponses,
                        firstChatterBotIllegalResponses),
                new ChatterBot(SECOND_CHATTER_BOT_NAME, secondChatterBotLegalResponses,
                        secondChatterBotIllegalResponses),
        };
    }
}
