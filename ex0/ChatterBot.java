...
class ChatterBot {
	 ...
	 * @return A response based on the type of the request and the possible responses given when constructing the chatterBot.
	 */
	...
	String replyToLegalRequest(String statement) {
		String phrase = statement.replaceFirst(REQUEST_PREFIX, ""); // delete the request prefix to avoid replying with it TODO check forum
		return replacePlaceholderInARandomPattern(repliesToLegalRequest, PLACEHOLDER_FOR_REQUESTED_PHRASE, phrase);
	}
	...
	/**
	 * Chooses a random response pattern from an array and replaces a specified placeholder with a given statement in the pattern.
	 *
	 ...
	 */
	String replacePlaceholderInARandomPattern(String[] possibleResponsePatterns, String placeHolder, String statementToPlace) {
