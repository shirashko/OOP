...
public class Board {
    ...
    private int size; // The size of the board, rows number and so as columns number (square board)
    private Mark[][] board;
     ...
     *
     * @param size The size of the board, number of rows and columns (square board).
     */
     ...
     * @return The mark at the specified location. Mark.BLANK will be returned also if got illegal
